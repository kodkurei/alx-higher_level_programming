...
class TestSquare_instantiation(unittest.TestCase):
    """Unittests testing instantiation of Square class."""
...
class TestSquare_size(unittest.TestCase):
    """Unittests testing size initialization of Square class."""

    def test_None_size(self):
        with self.assertRaisesRegex(TypeError, "width is an integer"):
            Square(None)
...
class TestSquare_area(unittest.TestCase):
    """Unittests testing the area method of Square class."""
...
class TestSquare_stdout(unittest.TestCase):
    ...
    def capture_stdout(sq, method):
        ...
        Args:
            sq (Square): The Square printing to stdout.
            method (str): The method to run on sq.
        Returns:
            The text printed to stdout calling method on sq.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestSquare_update_args(unittest.TestCase):
    """Unittests testing update args method of Square class."""
...
class TestSquare_to_dictionary(unittest.TestCase):
    """Unittests testing to_dictionary method of Square class."""
