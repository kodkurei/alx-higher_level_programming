...
class TestRectangle_instantiation(unittest.TestCase):
    """Unittests testing Rectangle class installation."""
...
class TestRectangle_height(unittest.TestCase):
    ...
    def test_None_height(self):
        with self.assertRaisesRegex(TypeError, "height is an integer"):
            Rectangle(1, None)
...
class TestRectangle_update_kwargs(unittest.TestCase):
    """Unittests testing update kwargs method of Rectangle class."""
...
class TestRectangle_to_dictionary(unittest.TestCase):
    """Unittests testing to_dictionary method of Rectangle class."""
